...
import (
	...
	mwLogger "github.com/napryag/url-shortener/internal/http-server/middleware/logger"
	"github.com/napryag/url-shortener/internal/lib/logger/handlers/slogpretty"
